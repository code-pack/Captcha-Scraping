""" 
Note: Slightly modified version of deathbycaptcha client python example script.
"""
...
if '__main__' == __name__:
    ...
    client = SocketClient('ACCOUNT INFO')
    ...
    for i in range(int(sys.argv[1]),int(sys.argv[2])):
        ...
        try:
            ...
            captcha = client.decode(str(i)+'.jpg', DEFAULT_TIMEOUT)
        except Exception, e:
        ...
        if captcha:
            ...
            fout=open(str(i)+'.txt2','w')
            fout.write(captcha['text'])
            fout.close()
